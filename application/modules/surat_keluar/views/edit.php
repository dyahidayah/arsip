...
<div class="p-5 w-100">
    ...
    <div class="row">
        ...
        <div class="col-md-6 offset-md-3">
            <form action="<?= site_url('surat_keluar/simpanedit_suratkeluar/').$detail->no_agenda ?>" method="post" enctype="multipart/form-data">
...
<script>
    ...
    $(document).ready(function() {
        ...
        mySelect.onchange = (event) => {
            ...
            $.ajax({
                url: base + 'surat_keluar/generate_jeniskategori/' + kategori,
                type: 'get',
                dataType: 'json',
            })
            .done(function(data) {
        ...
        {
            $.ajax({
                url: base + 'surat_keluar/generate_jeniskategori/' + value,
                type: 'get',
                dataType: 'json',
            })
            .done(function(data) {
