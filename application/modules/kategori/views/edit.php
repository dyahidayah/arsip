...
<div class="p-5 w-100">
    ...
    <div class="row">
        ...
        <div class="col-md-6 offset-md-3">
            <form action="<?= site_url('kategori/simpanedit_') . $active . '/' . $data->id_kategori ?>" method="post">
                <div class="form-group row">
                    <label for="id_kategori" class="col-sm-3 col-form-label">No Kategori*</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="id_kategori" name="id_kategori" value="<?= $data->id_kategori ?>" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="text" class="form-control" id="nama_kategori" name="nama_kategori" value="<?= $data->nama_kategori ?>" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="jenis_surat" class="col-sm-3 col-form-label">Jenis Surat</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="jenis_kategori" name="jenis_kategori" value="<?= ($data->jenis_kategori) ? $data->jenis_kategori : "" ?>" placeholder="Jenis Surat">
                    </div>
                </div>
                <div class="form-group row">
